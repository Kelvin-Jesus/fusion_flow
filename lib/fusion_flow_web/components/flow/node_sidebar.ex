            ...
            <div class="space-y-0.5">
              <%= for node <- nodes do %>
                <button
                  ...
                  title="Drag and drop onto the canvas to add"
                  class={[
                    "w-full flex items-center justify-between gap-3 px-4 py-2 text-sm font-medium transition-colors",
                    "w-full flex items-center justify-between gap-3 px-4 py-2 text-sm font-medium transition-colors text-gray-700 dark:text-slate-300 bg-transparent hover:bg-gray-100 dark:hover:bg-slate-700/50 focus:outline-none focus:bg-gray-100 dark:focus:bg-slate-700/50 cursor-grab active:cursor-grabbing"
                  ]}
                >
