defmodule FusionFlowWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FusionFlowWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FusionFlowWeb.Gettext, "errors", msg, opts)
    end
  end
