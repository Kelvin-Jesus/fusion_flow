defmodule FusionFlow.Accounts do
  @moduledoc """
  ...
  @doc """
  Gets a user by username/email and password.
  """
  ...
  """
  def sudo_mode?(user, minutes \\ -120)
  ...
  See `FusionFlow.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  @doc """
  Updates the user email directly without confirmation.
  """
  ...
  See `FusionFlow.Accounts.User.password_changeset/3` for a list of supported options.
